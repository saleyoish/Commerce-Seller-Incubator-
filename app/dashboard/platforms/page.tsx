    ...
    const platforms: PlatformConfig[] = [
      {
        ...
        status: 'connected', // Always connected in M2
        sales: 1234,
        username: '@sellername',
      },
      {
        ...
        description: 'Live auctions & collectibles',
      ...
      },
      {
        ...
        description: 'Live selling on Facebook',
      ...
      },
      {
        ...
        description: 'Live shopping on Instagram',
              ...
              {platform.status === 'connected' ? (
                <div className="space-y-4">
                  ...
                  <div className="flex gap-2 pt-2">
                    <Link href={`/dashboard/platforms/${platform.id}`} className="flex-1">
                ...
                <div className="space-y-4">
                  ...
                  <Link href={`/dashboard/platforms/${platform.id}`} className="w-full">
